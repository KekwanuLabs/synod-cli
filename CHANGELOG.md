...
### Added
- **Headless server support**: Auto-detects SSH sessions and missing DISPLAY on Linux
  - `synod login` automatically switches to manual API key entry on headless systems
